...
# 环境变量
UUID = os.environ.get('UUID', 'efac91eb-e851-4ef3-8f9b-d60d100e11fa')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'mnz.9943826.xyz:8008')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'v2IlOy13fMW0fOHMTuKPSeCliG1TGF2S')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
DOMAIN = os.environ.get('DOMAIN', 'momo.hostless.app')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub')         # 节点订阅token
NAME = os.environ.get('NAME', 'hostless')                    # 节点名称
